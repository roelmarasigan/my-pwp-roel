...
- ssh into the server
    - For Mac and Linux: `ssh root@rogeliom.com`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo rmarasigan`
    - replace rmarasigan with your own
- create password
    - `passwd rmarasigan`
- Move .ssh key file
    - `cp -r .ssh /home/rmarasigan`
- change ownership of the .ssh directory
    - `cd /home/rmarasigan`
    - `chown -R rmarasigan:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh rmarasigan@rogeliom.com`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- create a directory for your deployment
    - `sudo mkdir -p /var/www/rogeliom.com/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/rogeliom.com/html`
...
- `sudo vim /etc/nginx/sites-available/rogeliom.com`
...
server {
    ...
    root /var/www/rogeliom.com/html;
    index index.html index.htm index.nginx-debian.html;

    server_name rogeliom.com www.rogeliom.com;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/rogeliom.com /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/rmarasigan/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/rmarasigan/.ssh/github_deploy_key.pub >> /home/rmarasigan/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/rmarasigan/.ssh/github_deploy_key`
